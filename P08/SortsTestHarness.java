...
class SortsTestHarness 
{
    ...
    private static void usage() 
    {
        ...
        System.out.println("           q - Median quicksort");
        System.out.println("           z - quicksort random pivot");
    ...
    */
    public static void main(String[] args)
    {
        ...
        if (args.length < 2)
            ...
            int[] A = new int[n];
            int[] B = new int[]{45,31,34,78,1,3,4,84,13,12,41,90,99,100,75,58,83,64};
...
//                    long startTime = System.currentTimeMillis();
                    ...
                    switch (sortType)
                    {
                        ...
                        case 'z' : Sorts.randomQuicksort(A);break;
...
//                    long endTime = System.currentTimeMillis();
                ...
                System.out.println("Number of element sorted: " +args[numSorts]+ " " + n);
                System.out.println("Time taken: " + (runningTotal/(REPEATS-1)));
            }// end for numSorts
         } // end else
     } //main()
